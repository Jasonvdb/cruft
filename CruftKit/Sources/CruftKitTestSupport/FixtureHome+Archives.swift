...
extension FixtureHome {
    ...
    public static let archivesRootPath = "Library/Developer/Xcode/Archives"

    /// Plants an empty `Library/Developer/Xcode/Archives` directory.
    @discardableResult
    public func plantArchivesRoot() throws -> URL {
    ...
    @discardableResult
    public func plantXcodeArchiveFixture(name: String, dateDir: String? = "2026-06-01") throws -> URL {
    ...
    @discardableResult
    public func plantEmptyArchiveDateDir(_ dateDir: String) throws -> URL {
